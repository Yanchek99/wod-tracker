module CfWod
  class ExerciseBuilder
    ...
    def build(owner, position_value, line)
      stripped_line, inline_load = ExerciseLoadAttacher.extract_inline(line)
      ...
      ExerciseLoadAttacher.apply(exercise, inline_load) if inline_load
      exercise
    end
    ...
    def exercise_attributes(movement, position_value, parsed)
      {
        ...
        reps: parsed.reps || (format.interval ? 1 : nil),
