module CfWorkout
  class PageParser
    ...
    def parse
      container = workout_container
      raise Fetcher::UnrecognizedTemplateError, 'Unrecognized page template' unless container

      build_workout_page(container, bucket_paragraphs(container.css('p')))
    end
    ...
    def build_workout_page(container, buckets)
      WorkoutPage.new(
        date: date,
