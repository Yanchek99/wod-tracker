...
abmat_sit_up = Movement.find_or_initialize_by(name: 'AbMat Sit-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :hinge, skill_level: :basic)
  movement.save!
end
...
back_scale = Movement.find_or_initialize_by(name: 'Back Scale').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :hinge, skill_level: :intermediate)
  movement.save!
end
...
butterfly_pull_up = Movement.find_or_initialize_by(name: 'Butterfly Pull-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :pull,
...
clean = Movement.find_or_initialize_by(name: 'Clean').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :hinge, equipment: :barbell,
                             skill_level: :intermediate)
  movement.save!
end
clean_and_jerk = Movement.find_or_initialize_by(name: 'Clean and Jerk').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :mixed, equipment: :barbell,
                             skill_level: :advanced)
  movement.save!
end
clean_and_push_jerk = Movement.find_or_initialize_by(name: 'Clean and Push Jerk').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :mixed,
...
dip = Movement.find_or_initialize_by(name: 'Dip').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :press, skill_level: :basic)
  movement.save!
end
double_under = Movement.find_or_initialize_by(name: 'Double-under').tap do |movement|
  movement.assign_attributes(family: :monostructural, pattern: :jump, equipment: :jump_rope,
                             skill_level: :intermediate)
  movement.save!
end
dumbbell_bench_press = Movement.find_or_initialize_by(name: 'Dumbbell Bench Press').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :press,
...
dumbbell_clean = Movement.find_or_initialize_by(name: 'Dumbbell Clean').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :hinge, equipment: :dumbbell,
                             skill_level: :intermediate)
  movement.save!
end
dumbbell_deadlift = Movement.find_or_initialize_by(name: 'Dumbbell Deadlift').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :hinge,
                             equipment: :dumbbell, skill_level: :basic)
  movement.save!
end
dumbbell_farmers_carry = Movement.find_or_initialize_by(name: 'Dumbbell Farmers Carry').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :carry,
                             equipment: :dumbbell, skill_level: :basic)
  movement.save!
end
...
forward_roll_from_support = Movement.find_or_initialize_by(name: 'Forward Roll From Support').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :rotation,
                             skill_level: :advanced)
  movement.save!
end
...
ghd_back_extension = Movement.find_or_initialize_by(name: 'GHD Back Extension').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :hinge,
                             skill_level: :intermediate)
  movement.save!
end
...
ghd_sit_up = Movement.find_or_initialize_by(name: 'GHD Sit-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :rotation, skill_level: :intermediate)
  movement.save!
end
glide_kip = Movement.find_or_initialize_by(name: 'Glide Kip').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :pull, skill_level: :advanced)
  movement.save!
end
...
handstand = Movement.find_or_initialize_by(name: 'Handstand').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :inversion, skill_level: :intermediate)
  movement.save!
end
handstand_pirouette = Movement.find_or_initialize_by(name: 'Handstand Pirouette').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :inversion,
                             skill_level: :advanced)
  movement.save!
end
...
jumping_jack = Movement.find_or_initialize_by(name: 'Jumping Jack').tap do |movement|
  movement.assign_attributes(family: :monostructural, pattern: :jump, skill_level: :basic)
  movement.save!
end
jumping_lunge = Movement.find_or_initialize_by(name: 'Jumping Lunge').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :lunge, skill_level: :basic)
  movement.save!
end
...
kettlebell_sumo_hi_pull = Movement.find_or_initialize_by(name: 'Kettlebell Sumo Hi Pull').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :pull,
...
l_sit_on_rings = Movement.find_or_initialize_by(name: 'L-sit on Rings').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :rotation, equipment: :rings,
                             skill_level: :intermediate)
  movement.save!
end
l_sit_rope_climb = Movement.find_or_initialize_by(name: 'L-sit Rope Climb').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :pull, equipment: :rope,
                             skill_level: :advanced)
  movement.save!
end
...
deficit_push_up = Movement.find_or_initialize_by(name: 'Deficit Push-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :press,
                             skill_level: :intermediate)
  movement.save!
end
renegade_row = Movement.find_or_initialize_by(name: 'Renegade Row').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :pull, equipment: :dumbbell,
                             skill_level: :intermediate)
  movement.save!
end
rest = Movement.find_or_initialize_by(name: 'Rest').tap do |movement|
  movement.assign_attributes(family: :rest, pattern: :rest, skill_level: :basic)
  movement.save!
end
ring_dip = Movement.find_or_initialize_by(name: 'Ring Dip').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :press, equipment: :rings,
                             skill_level: :intermediate)
  movement.save!
end
ring_muscle_up = Movement.find_or_initialize_by(name: 'Ring Muscle-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :pull, equipment: :rings,
                             skill_level: :advanced)
  movement.save!
end
...
row = Movement.find_or_initialize_by(name: 'Row').tap do |movement|
  movement.assign_attributes(family: :monostructural, pattern: :pull, equipment: :machine, skill_level: :basic)
  movement.save!
end
run = Movement.find_or_initialize_by(name: 'Run').tap do |movement|
  movement.assign_attributes(family: :monostructural, pattern: :locomotion, skill_level: :basic)
  movement.save!
end
...
sit_up = Movement.find_or_initialize_by(name: 'Sit-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :rotation, skill_level: :basic)
  movement.save!
end
...
slam_ball = Movement.find_or_initialize_by(name: 'Slam Ball').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :mixed, equipment: :medicine_ball,
                             skill_level: :basic)
  movement.save!
end
sled_drag = Movement.find_or_initialize_by(name: 'Sled Drag').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :locomotion, equipment: :sled,
                             skill_level: :basic)
  movement.save!
end
sled_pull = Movement.find_or_initialize_by(name: 'Sled Pull').tap do |movement|
  movement.assign_attributes(family: :weightlifting, pattern: :pull, equipment: :sled,
                             skill_level: :basic)
  movement.save!
end
...
toes_to_bar = Movement.find_or_initialize_by(name: 'Toes to Bar').tap do |movement|
  movement.assign_attributes(family: :gymnastics, pattern: :rotation, equipment: :pull_up_bar,
                             skill_level: :intermediate)
  movement.save!
end
