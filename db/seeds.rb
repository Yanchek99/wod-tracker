...
abmat_sit_up = Movement.find_or_initialize_by(name: 'AbMat Sit-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:hinge], skill_level: :basic)
  movement.save!
end
air_squat = Movement.find_or_initialize_by(name: 'Air Squat').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat], skill_level: :basic)
  movement.save!
end
back_extensions = Movement.find_or_initialize_by(name: 'Back Extensions').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_extension], skill_level: :basic)
  movement.save!
end
back_scale = Movement.find_or_initialize_by(name: 'Back Scale').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:hinge], skill_level: :intermediate)
  movement.save!
end
back_squat = Movement.find_or_initialize_by(name: 'Back Squat').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:squat], equipment: :barbell,
                             skill_level: :basic)
  movement.save!
end
bar_muscle_up = Movement.find_or_initialize_by(name: 'Bar Muscle-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:vertical_pull], equipment: :pull_up_bar,
                             skill_level: :advanced)
  movement.save!
end
barbell_front_rack_lunge = Movement.find_or_initialize_by(name: 'Barbell Front-rack Lunge').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:squat],
                             equipment: :barbell, skill_level: :intermediate)
  movement.save!
end
bench_press = Movement.find_or_initialize_by(name: 'Bench Press').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:horizontal_push], equipment: :barbell,
                             skill_level: :basic)
  movement.save!
end
bent_over_row = Movement.find_or_initialize_by(name: 'Bent-over Row').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:horizontal_pull], equipment: :barbell,
                             skill_level: :basic)
  movement.save!
end
body_blaster = Movement.find_or_initialize_by(name: 'Body Blaster').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat, :vertical_push, :vertical_pull, :jump], skill_level: :intermediate)
  movement.save!
end
box_jump = Movement.find_or_initialize_by(name: 'Box Jump').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:jump], equipment: :box, skill_level: :basic)
  movement.save!
end
box_step_up = Movement.find_or_initialize_by(name: 'Box Step-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat], equipment: :box,
                             skill_level: :basic)
  movement.save!
end
burpee = Movement.find_or_initialize_by(name: 'Burpee').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat, :vertical_push, :jump], skill_level: :basic)
  movement.save!
end
burpee_box_jump = Movement.find_or_initialize_by(name: 'Burpee Box Jump').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat, :vertical_push, :jump], equipment: :box,
                             skill_level: :intermediate)
  movement.save!
end
burpee_box_jump_over = Movement.find_or_initialize_by(name: 'Burpee Box Jump-over').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat, :vertical_push, :jump],
...
butterfly_pull_up = Movement.find_or_initialize_by(name: 'Butterfly Pull-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:vertical_pull],
...
chest_to_wall_handstand_push_up = Movement.find_or_initialize_by(name: 'Chest-to-wall Handstand Push-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics,
                             patterns: [:inversion, :vertical_push],
                             skill_level: :advanced)
  movement.save!
end
clean = Movement.find_or_initialize_by(name: 'Clean').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:hinge], equipment: :barbell,
                             skill_level: :intermediate)
  movement.save!
end
clean_and_jerk = Movement.find_or_initialize_by(name: 'Clean and Jerk').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:hinge, :vertical_push], equipment: :barbell,
                             skill_level: :advanced)
  movement.save!
end
clean_and_push_jerk = Movement.find_or_initialize_by(name: 'Clean and Push Jerk').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:hinge, :vertical_push],
...
dip = Movement.find_or_initialize_by(name: 'Dip').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:vertical_push], skill_level: :basic)
  movement.save!
end
double_under = Movement.find_or_initialize_by(name: 'Double-under').tap do |movement|
  movement.assign_attributes(family: :monostructural, patterns: [:jump], equipment: :jump_rope,
                             skill_level: :intermediate)
  movement.save!
end
dumbbell_bench_press = Movement.find_or_initialize_by(name: 'Dumbbell Bench Press').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:horizontal_push],
...
dumbbell_clean = Movement.find_or_initialize_by(name: 'Dumbbell Clean').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:hinge], equipment: :dumbbell,
                             skill_level: :intermediate)
  movement.save!
end
dumbbell_deadlift = Movement.find_or_initialize_by(name: 'Dumbbell Deadlift').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:hinge],
                             equipment: :dumbbell, skill_level: :basic)
  movement.save!
end
dumbbell_farmers_carry = Movement.find_or_initialize_by(name: 'Dumbbell Farmers Carry').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:carry],
                             equipment: :dumbbell, skill_level: :basic)
  movement.save!
end
...
dumbbell_push_jerk = Movement.find_or_initialize_by(name: 'Dumbbell Push Jerk').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:vertical_push],
                             equipment: :dumbbell, skill_level: :intermediate)
  movement.save!
end
...
ghd_back_extension = Movement.find_or_initialize_by(name: 'GHD Back Extension').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_extension],
                             skill_level: :intermediate)
  movement.save!
end
...
ghd_sit_up = Movement.find_or_initialize_by(name: 'GHD Sit-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_flexion], skill_level: :intermediate)
  movement.save!
end
glide_kip = Movement.find_or_initialize_by(name: 'Glide Kip').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:vertical_pull], skill_level: :advanced)
  movement.save!
end
...
handstand = Movement.find_or_initialize_by(name: 'Handstand').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:inversion], skill_level: :intermediate)
  movement.save!
end
handstand_pirouette = Movement.find_or_initialize_by(name: 'Handstand Pirouette').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:inversion],
                             skill_level: :advanced)
  movement.save!
end
handstand_push_up = Movement.find_or_initialize_by(name: 'Handstand Push-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:inversion, :vertical_push],
                             skill_level: :advanced)
  movement.save!
end
...
jumping_jack = Movement.find_or_initialize_by(name: 'Jumping Jack').tap do |movement|
  movement.assign_attributes(family: :monostructural, patterns: [:jump], skill_level: :basic)
  movement.save!
end
...
kettlebell_sumo_hi_pull = Movement.find_or_initialize_by(name: 'Kettlebell Sumo Hi Pull').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:vertical_pull],
...
l_sit_on_rings = Movement.find_or_initialize_by(name: 'L-sit on Rings').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_flexion], equipment: :rings,
                             skill_level: :intermediate)
  movement.save!
end
l_sit_rope_climb = Movement.find_or_initialize_by(name: 'L-sit Rope Climb').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:vertical_pull], equipment: :rope,
                             skill_level: :advanced)
  movement.save!
end
...
lateral_over_barbell_burpee = Movement.find_or_initialize_by(name: 'Lateral Over Barbell Burpee').tap do |movement|
  movement.assign_attributes(family: :gymnastics,
                             patterns: [:squat, :vertical_push, :jump],
                             equipment: :barbell,
                             skill_level: :intermediate)
  movement.save!
end
...
power_clean_and_split_jerk = Movement.find_or_initialize_by(name: 'Power Clean and Split Jerk').tap do |movement|
  movement.assign_attributes(family: :weightlifting,
                             patterns: [:hinge, :vertical_push], equipment: :barbell,
                             skill_level: :advanced)
  movement.save!
end
...
push_jerk = Movement.find_or_initialize_by(name: 'Push Jerk').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:vertical_push], equipment: :barbell,
                             skill_level: :intermediate)
  movement.save!
end
...
push_up = Movement.find_or_initialize_by(name: 'Push-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:horizontal_push], skill_level: :basic)
  movement.save!
end
deficit_push_up = Movement.find_or_initialize_by(name: 'Deficit Push-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:horizontal_push],
                             skill_level: :intermediate)
  movement.save!
end
renegade_row = Movement.find_or_initialize_by(name: 'Renegade Row').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:horizontal_pull], equipment: :dumbbell,
                             skill_level: :intermediate)
  movement.save!
end
rest = Movement.find_or_initialize_by(name: 'Rest').tap do |movement|
  movement.assign_attributes(family: :rest, patterns: [:rest], skill_level: :basic)
  movement.save!
end
ring_dip = Movement.find_or_initialize_by(name: 'Ring Dip').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:vertical_push], equipment: :rings,
                             skill_level: :intermediate)
  movement.save!
end
ring_muscle_up = Movement.find_or_initialize_by(name: 'Ring Muscle-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:vertical_pull], equipment: :rings,
                             skill_level: :advanced)
  movement.save!
end
ring_push_up = Movement.find_or_initialize_by(name: 'Ring Push-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:horizontal_push], equipment: :rings,
                             skill_level: :intermediate)
  movement.save!
end
ring_row = Movement.find_or_initialize_by(name: 'Ring Row').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:horizontal_pull], equipment: :rings,
                             skill_level: :basic)
  movement.save!
end
...
row = Movement.find_or_initialize_by(name: 'Row').tap do |movement|
  movement.assign_attributes(family: :monostructural, patterns: [:horizontal_pull], equipment: :machine, skill_level: :basic)
  movement.save!
end
run = Movement.find_or_initialize_by(name: 'Run').tap do |movement|
  movement.assign_attributes(family: :monostructural, patterns: [:locomotion], skill_level: :basic)
  movement.save!
end
shoot_through = Movement.find_or_initialize_by(name: 'Shoot-through').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat, :vertical_push], skill_level: :intermediate)
  movement.save!
end
...
single_leg_squat_pistol = Movement.find_or_initialize_by(name: 'Single-leg Squat (Pistol)').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:squat],
                             skill_level: :advanced)
  movement.save!
end
...
sit_up = Movement.find_or_initialize_by(name: 'Sit-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_flexion], skill_level: :basic)
  movement.save!
end
...
slam_ball = Movement.find_or_initialize_by(name: 'Slam Ball').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:hinge, :vertical_push], equipment: :medicine_ball,
                             skill_level: :basic)
  movement.save!
end
sled_drag = Movement.find_or_initialize_by(name: 'Sled Drag').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:locomotion], equipment: :sled,
                             skill_level: :basic)
  movement.save!
end
sled_pull = Movement.find_or_initialize_by(name: 'Sled Pull').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:vertical_pull], equipment: :sled,
                             skill_level: :basic)
  movement.save!
end
...
thruster = Movement.find_or_initialize_by(name: 'Thruster').tap do |movement|
  movement.assign_attributes(family: :weightlifting, patterns: [:squat, :vertical_push], equipment: :barbell,
                             skill_level: :intermediate)
  movement.save!
end
toes_to_bar = Movement.find_or_initialize_by(name: 'Toes to Bar').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_flexion], equipment: :pull_up_bar,
                             skill_level: :intermediate)
  movement.save!
end
toes_to_bar_pull_up = Movement.find_or_initialize_by(name: 'Toes to Bar + Pull-up').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_flexion, :vertical_pull],
                             equipment: :pull_up_bar, skill_level: :advanced)
  movement.save!
end
...
windshield_wiper = Movement.find_or_initialize_by(name: 'Windshield Wiper').tap do |movement|
  movement.assign_attributes(family: :gymnastics, patterns: [:trunk_rotation],
                             skill_level: :advanced)
  movement.save!
end
