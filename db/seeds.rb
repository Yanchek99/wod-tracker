...
# Movements
three_position_power_snatch = Movement.find_or_create_by(name: '3-Position Power Snatch')
abmat_sit_up = Movement.find_or_create_by(name: 'AbMat Sit-up')
# Renamed from "Bike": Assault Bike and Echo Bike are both air bikes, and the plain "Bike" name
# was ambiguous with a road/spin bike. Variable name stays `bike` -- hero_workouts.rb references
# this exact local (see the shared-binding eval at the bottom of this file).
bike = Movement.find_or_create_by(name: 'Air Bike')
...
box_squat = Movement.find_or_create_by(name: 'Box Squat')
...
bulgarian_split_squat = Movement.find_or_create_by(name: 'Bulgarian Split Squat')
...
butterfly_sit_up = Movement.find_or_create_by(name: 'Butterfly Sit-up')
...
clean_pull = Movement.find_or_create_by(name: 'Clean Pull')
...
devil_press = Movement.find_or_create_by(name: 'Devil Press')
...
dumbbell_goblet_squat = Movement.find_or_create_by(name: 'Dumbbell Goblet Squat')
...
dumbbell_shoulder_press = Movement.find_or_create_by(name: 'Dumbbell Shoulder Press')
dumbbell_shoulder_to_overhead = Movement.find_or_create_by(name: 'Dumbbell Shoulder to Overhead')
dumbbell_snatch = Movement.find_or_create_by(name: 'Dumbbell Snatch')
...
front_box_squat = Movement.find_or_create_by(name: 'Front Box Squat')
front_pause_squat = Movement.find_or_create_by(name: 'Front Pause Squat')
front_rack_lunges = Movement.find_or_create_by(name: 'Front Rack Lunges')
...
glute_bridge = Movement.find_or_create_by(name: 'Glute Bridge')
...
hang_squat_snatch = Movement.find_or_create_by(name: 'Hang Squat Snatch')
...
inchworm_push_up = Movement.find_or_create_by(name: 'Inchworm Push-up')
...
muscle_clean = Movement.find_or_create_by(name: 'Muscle Clean')
...
power_clean_and_jerk = Movement.find_or_create_by(name: 'Power Clean and Jerk')
...
reverse_burpee = Movement.find_or_create_by(name: 'Reverse Burpee')
...
seated_press = Movement.find_or_create_by(name: 'Seated Press')
...
single_leg_deadlift = Movement.find_or_create_by(name: 'Single-leg Deadlift')
...
ski_erg = Movement.find_or_create_by(name: 'Ski Erg')
...
snatch_grip_push_press = Movement.find_or_create_by(name: 'Snatch Grip Push Press')
snatch_pull = Movement.find_or_create_by(name: 'Snatch Pull')
...
squat_clean = Movement.find_or_create_by(name: 'Squat Clean')
...
suitcase_deadlift = Movement.find_or_create_by(name: 'Suitcase Deadlift')
...
wall_climb = Movement.find_or_create_by(name: 'Wall Climb')
