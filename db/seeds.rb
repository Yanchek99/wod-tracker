...
Movement.find_or_create_by(name: 'Box Jump', measurement: rep)
Movement.find_or_create_by(name: 'Burpee', measurement: rep)
...
Movement.find_or_create_by(name: 'Clean Squat', measurement: weight)
...
Movement.find_or_create_by(name: 'Handstand Push-up', measurement: rep)
...
Movement.find_or_create_by(name: 'Pull-up', measurement: rep)
Movement.find_or_create_by(name: 'Rest', measurement: time)
